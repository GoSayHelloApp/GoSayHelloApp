    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {/* Sign in — text only, hides on tiny phones */}
            <Box
              component="button"
              type="button"
            ...
            <Box
              ...
              sx={{
                ...
                outline: "none",
                WebkitTapHighlightColor: "transparent",
                transition: `transform 200ms ${tokens.motion.swift}, background 200ms ${tokens.motion.swift}, color 200ms ${tokens.motion.swift}, box-shadow 200ms ${tokens.motion.swift}`,
                "&:hover": {
