...
const EventPage = () => {
  ...
  const formatDateTime = (startDate: string, endDate: string, startTime: string, endTime: string) => {
    ...
    // Get the correct time zone abbreviation
    const timeZoneFormatter = new Intl.DateTimeFormat("en-US", { timeZoneName: "short" });
    const timeZoneParts = timeZoneFormatter.formatToParts(startDateTime);
    ...
    const formattedStartTime = startDateTime.toLocaleTimeString("en-US", timeOptions);
    const formattedEndTime = endDateTime.toLocaleTimeString("en-US", timeOptions);

    return `${formattedDate} at ${formattedStartTime} - ${formattedEndTime} (${timeZone})`;
  };
      ...
      >
        ...
        >
          ...
          >
            ...
            <Box display="flex" justifyContent="center" gap={1} mt={2} padding={3}>
              <AvatarGroup max={4}>
        ...
        >
          ...
          >
            ...
            <Button
              variant="contained"
              color="primary"
              href="https://gosayhello.page.link/?ibi=com.saee.GoSayHELLO&isi=1585044833&apn=com.gosayhello&link=https://gosayhello.page.link/eventdata?event_id=2932&efr=1"
              target="_blank"
            >
              Download App
            </Button>
