                ...
                <Box
                    ...
                    >
                        {image ? (
                            ...
                            <Typography sx={{ py: 2 }} color={theme.palette.info.contrastText} >Choose photo</Typography>
                        )}
                        <input
                    ...
                    {formik.touched.image && formik.errors.image && (
                        <Typography color="error" mb={3} variant="body2">{formik.errors.image}</Typography>
                    )}
